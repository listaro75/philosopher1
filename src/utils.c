...
/**
 * @brief Convertit une chaîne de caractères en entier (version simplifiée d'atoi)
 * 
 ...
 * 2. Pour chaque chiffre (0-9), multiplie le résultat par 10 et ajoute le chiffre
 * 3. S'arrête au premier caractère non-numérique ou à la fin de la chaîne
 * 
 * Limitations :
