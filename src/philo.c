 ...
 * - Philosophes PAIRS (id % 2 == 0) : prennent d'abord la fourchette DROITE puis GAUCHE
 * - Philosophes IMPAIRS (id % 2 == 1) : prennent d'abord la fourchette GAUCHE puis DROITE
 * 
 ...
 * 
 * @param data Pointeur vers la structure contenant tous les paramètres et philosophes
 * @return int 1 si la simulation s'est déroulée avec succès, 0 en cas d'erreur
 * 
 * Phase de lancement :
 ...
 * - Sleep de 1ms entre chaque vérification (évite la consommation CPU excessive)
